/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.example` (hash: 922e3e7ebc9eaa5666fdd80070661526)
// Runtime types generated with workerd@1.20260820.1 2026-08-18 nodejs_compat
interface __BaseEnv_Env {
	...
	MOCK_AI: "false" | "true";
	MOCK_AI_DELAY_MS: "0";
	AUTH_PHRASE_SALT?: string;
	AUTH_PHRASE_VERIFIER?: string;
	SESSION_SIGNING_KEY?: string;
	OPENAI_API_KEY?: string;
	FEEDBACK_EXPORT_TOKEN?: string;
	GENERATION_WORKFLOW: Workflow<Parameters<import("./workers/app").GenerationWorkflow['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_VERSION" | "MOCK_AI" | "MOCK_AI_DELAY_MS" | "AUTH_PHRASE_SALT" | "AUTH_PHRASE_VERIFIER" | "SESSION_SIGNING_KEY" | "OPENAI_API_KEY" | "FEEDBACK_EXPORT_TOKEN">> {}
}
